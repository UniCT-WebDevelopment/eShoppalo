                    ...
                    document.querySelector('.confirm-price-button').onclick = ()=>{
                        ...
                        if(document.querySelector('.prices-bar-pre')){
                            ...
                            document.querySelector('.prices-bar-pre').onanimationend = ()=>{
                                ...
                                priceMineValue.textContent = selectedPrice.toString().replace('.',',') + '€';
                            ...
                            document.querySelector('.main-graph').onanimationend = ()=>{
                                ...
                                document.querySelector('.price-mine > .price-subtext').textContent = selectedPrice.toString().replace('.',',') + '€';
                                actualDevalActual = (100 - parseInt(selectedPrice*100/selectedGame.price_sorting_f));
                ...
                success: function(data){
                    if(data == 'none'){
                        ...
                        document.querySelector('.step-text').onanimationend = ()=>{
                            ...
                            priceNewValue.textContent = selectedGame.price_sorting_f.toString().replace('.',',') + '€';
                            ...
                            dataAvg = data.avg
                            priceAvgValue.textContent = dataAvg.toString().replace('.',',') + '€';
                            ...
                            priceRightValue.textContent = prezzoGiusto.toString().replace('.',',') + '€';
